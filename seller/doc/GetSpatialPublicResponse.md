...
**items** | [**List<GetSpatialPublicResponseItems>**](GetSpatialPublicResponseItems.md) | Enough to draw an object and label it. No cost, no location, no status. | [default to const []]
