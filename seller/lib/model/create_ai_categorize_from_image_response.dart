...
class CreateAiCategorizeFromImageResponse {
  /// Returns a new [CreateAiCategorizeFromImageResponse] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CreateAiCategorizeFromImageResponse &&
  ...
  /// Returns a new [CreateAiCategorizeFromImageResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CreateAiCategorizeFromImageResponse fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<CreateAiCategorizeFromImageResponse> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(CreateAiCategorizeFromImageResponse.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <CreateAiCategorizeFromImageResponse>[];

  static Map<String, CreateAiCategorizeFromImageResponse> mapFromJson(dynamic json) {
    final map = <String, CreateAiCategorizeFromImageResponse>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = CreateAiCategorizeFromImageResponse.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of CreateAiCategorizeFromImageResponse-objects as value to a dart map
  static Map<String, List<CreateAiCategorizeFromImageResponse>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<CreateAiCategorizeFromImageResponse>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = CreateAiCategorizeFromImageResponse.listFromJson(
            value,
