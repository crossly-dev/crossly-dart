...
class GetActionLogResponse {
  /// Returns a new [GetActionLogResponse] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is GetActionLogResponse &&
     other.id == id &&
  ...
  /// Returns a new [GetActionLogResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static GetActionLogResponse fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<GetActionLogResponse> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(GetActionLogResponse.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <GetActionLogResponse>[];

  static Map<String, GetActionLogResponse> mapFromJson(dynamic json) {
    final map = <String, GetActionLogResponse>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = GetActionLogResponse.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of GetActionLogResponse-objects as value to a dart map
  static Map<String, List<GetActionLogResponse>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<GetActionLogResponse>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = GetActionLogResponse.listFromJson(
            value,
