...
class GetMeTemplateResponse {
  /// Returns a new [GetMeTemplateResponse] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is GetMeTemplateResponse &&
     other.id == id &&
     other.brand == brand &&
     other.name == name &&
  ...
  @override
  String toString() => 'GetMeTemplateResponse[id=$id, brand=$brand, name=$name, createdAt=$createdAt, updatedAt=$updatedAt, userId=$userId, condition=$condition, size=$size, material=$material, style=$style, pattern=$pattern, department=$department, gender=$gender, itemType=$itemType, sizeSystem=$sizeSystem, color=$color, tags=$tags, notes=$notes, weightOz=$weightOz, isDefault=$isDefault, description=$description, title=$title, scope=$scope, shareToken=$shareToken, descriptionVariants=$descriptionVariants, titleVariants=$titleVariants, defaultForCategory=$defaultForCategory, sortOrder=$sortOrder]';
  ...
  /// Returns a new [GetMeTemplateResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static GetMeTemplateResponse fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<GetMeTemplateResponse> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(GetMeTemplateResponse.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <GetMeTemplateResponse>[];

  static Map<String, GetMeTemplateResponse> mapFromJson(dynamic json) {
    final map = <String, GetMeTemplateResponse>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = GetMeTemplateResponse.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of GetMeTemplateResponse-objects as value to a dart map
  static Map<String, List<GetMeTemplateResponse>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<GetMeTemplateResponse>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = GetMeTemplateResponse.listFromJson(
            value,
