...
class CreateReturnResponse {
  /// Returns a new [CreateReturnResponse] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CreateReturnResponse &&
     other.id == id &&
  ...
  /// Returns a new [CreateReturnResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CreateReturnResponse fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<CreateReturnResponse> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(CreateReturnResponse.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <CreateReturnResponse>[];

  static Map<String, CreateReturnResponse> mapFromJson(dynamic json) {
    final map = <String, CreateReturnResponse>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = CreateReturnResponse.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of CreateReturnResponse-objects as value to a dart map
  static Map<String, List<CreateReturnResponse>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<CreateReturnResponse>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = CreateReturnResponse.listFromJson(
            value,
