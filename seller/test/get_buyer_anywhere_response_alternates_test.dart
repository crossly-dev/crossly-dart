...
// tests for GetBuyerAnywhereResponseAlternates
void main() {
  final instance = GetBuyerAnywhereResponseAlternates();

  group('test GetBuyerAnywhereResponseAlternates', () {
    // String storeId
    ...
    test('to test the property `buyerCashbackCents`', () async {
      // TODO
    });

    // Item + shipping when known; item alone otherwise. See `shippingUnknown`.
    // num deliveredCents
    test('to test the property `deliveredCents`', () async {
      // TODO
    });
