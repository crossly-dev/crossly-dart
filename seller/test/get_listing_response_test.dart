...
// tests for GetListingResponse
void main() {
  final instance = GetListingResponse();

  group('test GetListingResponse', () {
    // List<GetListingResponsePlatformListings> platformListings (default value: const [])
