...
// tests for GetActionLogResponse
void main() {
  final instance = GetActionLogResponse();

  group('test GetActionLogResponse', () {
    // String id
    ...
    // String oauthAppId
    test('to test the property `oauthAppId`', () async {
      // TODO
    });
    ...
    // num httpStatus
    test('to test the property `httpStatus`', () async {
      // TODO
    });
    ...
    // String actorEmail
    test('to test the property `actorEmail`', () async {
      // TODO
    });
