...
// tests for CreateAiGenerateListingResponse
void main() {
  final instance = CreateAiGenerateListingResponse();

  group('test CreateAiGenerateListingResponse', () {
    ...
    test('to test the property `priceRange`', () async {
      // TODO
    });
    ...
    test('to test the property `suggestedTitle`', () async {
      // TODO
    });
