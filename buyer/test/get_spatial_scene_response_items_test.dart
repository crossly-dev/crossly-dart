...
// tests for GetSpatialSceneResponseItems
void main() {
  final instance = GetSpatialSceneResponseItems();

  group('test GetSpatialSceneResponseItems', () {
    // String id
    ...
    // String thumbUrl
    test('to test the property `thumbUrl`', () async {
      // TODO
    });
    ...
    // num costCents
    test('to test the property `costCents`', () async {
      // TODO
    });

    // Days since first listed anywhere. Drives the `aging` overlay.
    // num ageDays
    test('to test the property `ageDays`', () async {
      // TODO
    });
    ...
    // bool marketTagged
    test('to test the property `marketTagged`', () async {
      // TODO
    });
