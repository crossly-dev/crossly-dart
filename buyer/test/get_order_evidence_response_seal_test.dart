...
// tests for GetOrderEvidenceResponseSeal
void main() {
  final instance = GetOrderEvidenceResponseSeal();

  group('test GetOrderEvidenceResponseSeal', () {
    // GetOrderEvidenceResponseSealAssessment assessment
    test('to test the property `assessment`', () async {
      // TODO
    });
    ...
    test('to test the property `dispatchSearchedFrames`', () async {
      // TODO
    });

    // bool hasDispatch
    test('to test the property `hasDispatch`', () async {
      // TODO
    });

    // bool hasArrival
    test('to test the property `hasArrival`', () async {
      // TODO
    });

    // A courier photo exists, even if the seal was not legible in it.
    // bool hasCourierPhoto
    test('to test the property `hasCourierPhoto`', () async {
      // TODO
    });
