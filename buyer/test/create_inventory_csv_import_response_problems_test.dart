...
// tests for CreateInventoryCsvImportResponseProblems
void main() {
  final instance = CreateInventoryCsvImportResponseProblems();

  group('test CreateInventoryCsvImportResponseProblems', () {
