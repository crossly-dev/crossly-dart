...
// tests for ListInventoryUnitsItem
void main() {
  final instance = ListInventoryUnitsItem();

  group('test ListInventoryUnitsItem', () {
    // String id
    ...
    // List<ListInventoryUnitsItemIdentifiers> identifiers (default value: const [])
