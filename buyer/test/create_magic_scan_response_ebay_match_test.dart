...
// tests for CreateMagicScanResponseEbayMatch
void main() {
  final instance = CreateMagicScanResponseEbayMatch();

  group('test CreateMagicScanResponseEbayMatch', () {
    // String itemId
    ...
    // String legacyItemId
    test('to test the property `legacyItemId`', () async {
      // TODO
    });
    ...
    // String itemUrl
    test('to test the property `itemUrl`', () async {
      // TODO
    });
