# crossly_buyer.model.GetOrderEvidenceResponseGrade
...
**grade** | **String** |  | 
**points** | **num** |  | 
**signals** | [**List<GetOrderEvidenceResponseGradeSignals>**](GetOrderEvidenceResponseGradeSignals.md) |  | [default to const []]
