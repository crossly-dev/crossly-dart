...
class CreateAiCategorizeResponse {
  /// Returns a new [CreateAiCategorizeResponse] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CreateAiCategorizeResponse &&
  ...
  /// Returns a new [CreateAiCategorizeResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CreateAiCategorizeResponse fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<CreateAiCategorizeResponse> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(CreateAiCategorizeResponse.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <CreateAiCategorizeResponse>[];

  static Map<String, CreateAiCategorizeResponse> mapFromJson(dynamic json) {
    final map = <String, CreateAiCategorizeResponse>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = CreateAiCategorizeResponse.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of CreateAiCategorizeResponse-objects as value to a dart map
  static Map<String, List<CreateAiCategorizeResponse>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<CreateAiCategorizeResponse>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = CreateAiCategorizeResponse.listFromJson(
            value,
