...
class CreateAiGenerateListingResponse {
  /// Returns a new [CreateAiGenerateListingResponse] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CreateAiGenerateListingResponse &&
  ...
  /// Returns a new [CreateAiGenerateListingResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CreateAiGenerateListingResponse fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<CreateAiGenerateListingResponse> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(CreateAiGenerateListingResponse.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <CreateAiGenerateListingResponse>[];

  static Map<String, CreateAiGenerateListingResponse> mapFromJson(dynamic json) {
    final map = <String, CreateAiGenerateListingResponse>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = CreateAiGenerateListingResponse.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of CreateAiGenerateListingResponse-objects as value to a dart map
  static Map<String, List<CreateAiGenerateListingResponse>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<CreateAiGenerateListingResponse>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = CreateAiGenerateListingResponse.listFromJson(
            value,
