...
class ListReturnsItem {
  /// Returns a new [ListReturnsItem] instance.
  ListReturnsItem({
    @required this.id,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ListReturnsItem &&
     other.id == id &&
  ...
  /// Returns a new [ListReturnsItem] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ListReturnsItem fromJson(dynamic value) {
    if (value is Map) {
      final json = value.cast<String, dynamic>();
      return ListReturnsItem(
  ...
  static List<ListReturnsItem> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(ListReturnsItem.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <ListReturnsItem>[];

  static Map<String, ListReturnsItem> mapFromJson(dynamic json) {
    final map = <String, ListReturnsItem>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = ListReturnsItem.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of ListReturnsItem-objects as value to a dart map
  static Map<String, List<ListReturnsItem>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<ListReturnsItem>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = ListReturnsItem.listFromJson(
            value,
