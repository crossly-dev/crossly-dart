...
class GetImportResponse {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is GetImportResponse &&
     other.id == id &&
  ...
  /// Returns a new [GetImportResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static GetImportResponse fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<GetImportResponse> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(GetImportResponse.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <GetImportResponse>[];

  static Map<String, GetImportResponse> mapFromJson(dynamic json) {
    final map = <String, GetImportResponse>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = GetImportResponse.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of GetImportResponse-objects as value to a dart map
  static Map<String, List<GetImportResponse>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<GetImportResponse>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = GetImportResponse.listFromJson(
            value,
