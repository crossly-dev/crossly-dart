...
class GetBuyerAnywhereResponseAlternates {
  /// Returns a new [GetBuyerAnywhereResponseAlternates] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is GetBuyerAnywhereResponseAlternates &&
  ...
  @override
  String toString() => 'GetBuyerAnywhereResponseAlternates[storeId=$storeId, host=$host, storeName=$storeName, title=$title, priceCents=$priceCents, shippingCents=$shippingCents, currency=$currency, condition=$condition, url=$url, imageUrl=$imageUrl, buyerCashbackCents=$buyerCashbackCents, deliveredCents=$deliveredCents, shippingUnknown=$shippingUnknown]';
  ...
  /// Returns a new [GetBuyerAnywhereResponseAlternates] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static GetBuyerAnywhereResponseAlternates fromJson(dynamic value) {
    if (value is Map) {
      final json = value.cast<String, dynamic>();
      return GetBuyerAnywhereResponseAlternates(
  ...
  static List<GetBuyerAnywhereResponseAlternates> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(GetBuyerAnywhereResponseAlternates.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <GetBuyerAnywhereResponseAlternates>[];

  static Map<String, GetBuyerAnywhereResponseAlternates> mapFromJson(dynamic json) {
    final map = <String, GetBuyerAnywhereResponseAlternates>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = GetBuyerAnywhereResponseAlternates.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of GetBuyerAnywhereResponseAlternates-objects as value to a dart map
  static Map<String, List<GetBuyerAnywhereResponseAlternates>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<GetBuyerAnywhereResponseAlternates>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = GetBuyerAnywhereResponseAlternates.listFromJson(
            value,
